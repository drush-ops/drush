...
use Drush\Commands\field\FieldBaseInfoCommand;
use Drush\Commands\field\FieldBaseOverrideCreateCommand;
use Drush\Commands\field\FieldCreateCommand;
use Drush\Commands\field\FieldDeleteCommand;
...
class FieldTest extends CommandUnishTestCase
{
    ...
    {
        // Arguments.
        $this->drush(FieldCreateCommand::NAME, [], [], null, null, self::EXIT_ERROR);
        $this->assertStringContainsString('The entityType argument is required', $this->getErrorOutputRaw());
        $this->drush(FieldCreateCommand::NAME, ['foo'], [], null, null, self::EXIT_ERROR);
        $this->assertStringContainsString('Entity type with id \'foo\' does not exist.', $this->getErrorOutputRaw());
        $this->drush(FieldCreateCommand::NAME, ['unish_article'], [], null, null, self::EXIT_ERROR);
        $this->assertStringContainsString('The bundle argument is required.', $this->getErrorOutputRaw());
        $this->drush(FieldCreateCommand::NAME, ['user', 'user'], [], null, null, self::EXIT_ERROR);
        $this->assertStringNotContainsString('bundle', $this->getErrorOutputRaw());

        // New field storage
        $this->drush(FieldCreateCommand::NAME, ['unish_article', 'alpha'], ['field-label' => 'Test', 'field-name' => 'field_test2', 'field-type' => 'entity_reference', 'field-widget' => 'entity_reference_autocomplete', 'cardinality' => FieldStorageDefinitionInterface::CARDINALITY_UNLIMITED], null, null, self::EXIT_ERROR);
        $this->assertStringContainsString('The target-type option is required.', $this->getErrorOutputRaw());
        $this->drush(FieldCreateCommand::NAME, ['unish_article', 'alpha'], ['field-label' => 'Test', 'field-name' => 'field_test6', 'field-type' => 'entity_reference', 'field-widget' => 'entity_reference_autocomplete', 'cardinality' => '-1', 'target-type' => 'unish_article', 'target-bundle' => 'NO-EXIST'], null, null, self::EXIT_ERROR);
        ...
        $this->drush(FieldCreateCommand::NAME, ['unish_article', 'alpha'], ['field-label' => 'Test', 'field-name' => 'field_test3', 'field-type' => 'entity_reference', 'field-widget' => 'entity_reference_autocomplete', 'cardinality' => FieldStorageDefinitionInterface::CARDINALITY_UNLIMITED, 'target-type' => 'unish_article', 'target-bundle' => 'beta']);
        ...
        $this->drush(FieldCreateCommand::NAME, ['unish_article', 'alpha'], ['field-name' => 'field_test3', 'field-label' => 'Body'], null, null, self::EXIT_ERROR);
        ...
        // Allowed formats
        $this->drush(FieldCreateCommand::NAME, ['unish_article', 'alpha'], ['field-name' => 'field_test_allowed_formats', 'field-label' => 'Text', 'field-type' => 'text_long', 'cardinality' => 1, 'allowed-formats' => 'baz'], null, null, self::EXIT_ERROR);
        $this->assertStringContainsString('The following text formats do not exist: baz', $this->getSimplifiedErrorOutput());
        $this->drush(FieldCreateCommand::NAME, ['unish_article', 'alpha'], ['field-name' => 'field_test_allowed_formats', 'field-label' => 'Text', 'field-type' => 'text_long', 'cardinality' => 1, 'allowed-formats' => 'plain_text']);
    ...
    public function testFieldDelete(): void
    {
        ...
        $this->drush(FieldDeleteCommand::NAME, ['unish_article'], ['field-name' => 'field_test5'], null, null, self::EXIT_ERROR);
        $this->assertStringContainsString('The bundle argument is required.', $this->getErrorOutputRaw());
        $this->drush(FieldDeleteCommand::NAME, ['unish_article', 'alpha'], [], null, null, self::EXIT_ERROR);
        $this->assertStringContainsString('The field-name option is required.', $this->getErrorOutputRaw());

        $this->drush(FieldDeleteCommand::NAME, ['unish_article', 'alpha'], ['field-name' => 'field_testZZZZZ'], null, null, self::EXIT_ERROR);
        $this->assertStringContainsString("Field with name 'field_testZZZZZ' does not exist.", $this->getErrorOutputRaw());
        $this->drush(FieldDeleteCommand::NAME, ['unish_article', 'alpha'], ['field-name' => 'field_test5']);
        $this->assertStringContainsString(" The field Test has been deleted from the Alpha bundle.", $this->getErrorOutputRaw());

        // All bundles
        $this->drush(FieldCreateCommand::NAME, ['unish_article', 'alpha'], ['field-label' => 'Test', 'field-name' => 'field_test5', 'field-description' => 'baz', 'field-type' => 'entity_reference', 'is-required' => true, 'field-widget' => 'entity_reference_autocomplete', 'cardinality' => FieldStorageDefinitionInterface::CARDINALITY_UNLIMITED, 'target-type' => 'unish_article', 'target-bundle' => 'beta']);
        $this->drush(FieldDeleteCommand::NAME, ['unish_article'], ['field-name' => 'field_test5', 'all-bundles' => true]);
        $this->assertStringContainsString("The field Test has been deleted from the Alpha bundle.", $this->getErrorOutputRaw());
    }

    public function testFieldBaseInfo(): void
    {
        $this->drush(FieldBaseInfoCommand::NAME, ['user'], ['format' => 'json', 'fields' => '*']);
    ...
    public function testFieldBaseCreateOverride(): void
    {
        ...
        $this->drush(FieldBaseOverrideCreateCommand::NAME, ['user', 'user'], $options);
