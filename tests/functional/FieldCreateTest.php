...
http://dev/admin/structure/unish_article_types/manage/alpha/fields/unish_article.alpha.field_test3", $this->getErrorOutputRaw());
        ...
        $this->assertStringContainsString('Field storage with name \'field_test3\' already exists. Call this command with the --existing option to add an existing field to a bundle.', $this->getErrorOutputRaw());
