...
class ModuleDrushCommandTest extends CommandUnishTestCase
{
    ...
    public function testLogMessageRetrieval()
    {
        ...
        $this->assertStringContainsString('Message1', $this->getErrorOutput());
        $this->assertStringContainsString('Message2', $this->getErrorOutput());
        $this->assertStringContainsString('Message3', $this->getErrorOutput());
    }
}
