 ...
 *
 * This is the actual implementation of the logger. This class
 * is called directly in the early preflight; it should not be
 * directly accessed by other code, though.
 */
