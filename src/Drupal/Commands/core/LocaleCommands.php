...
class LocaleCommands extends DrushCommands
{
    ...
    #[CLI\Option(name: 'types', description: 'String types to include, defaults to all types. Recognized values: <info>not-customized</info>, <info>customized</info>, </info>not-translated<info>')]
