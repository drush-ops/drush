...
final class SqlCommands extends DrushCommands implements StdinAwareInterface
{
    ...
    #[CLI\Usage(name: 'drush php:eval --format=json "return \Drupal\Core\Database\Connection::query(\'SELECT * FROM users\')->fetchAll()"', description: 'Get data back in JSON format. See https://github.com/drush-ops/drush/issues/3071#issuecomment-347929777.')]
